...
def main():
  sol = Solution()
  print("Smallest subarray length: " + str(sol.smallest_subarray(7, [2, 1, 5, 2, 3, 2])))
  print("Smallest subarray length: " + str(sol.smallest_subarray(7, [2, 1, 5, 2, 8])))
  print("Smallest subarray length: " + str(sol.smallest_subarray(8, [3, 4, 1, 1, 6])))
