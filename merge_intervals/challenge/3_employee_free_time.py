    ...
    def find_free_time(self, schedule):
        ...
        while min_heap:
            ...
            if previous_end < curr_employee_interval.interval.start:
                result.append(Interval(previous_end, curr_employee_interval.interval.start))
            ...
            if len(curr_employees_schedule) > curr_interval_index+1:
                ...
                heappush(min_heap, EmployeeInterval(curr_employees_schedule[curr_interval_index+1], curr_employee_index, curr_interval_index+1))
